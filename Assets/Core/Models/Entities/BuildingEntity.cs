...
public class BuildingEntity : Entity
{
    ...
    public BuildingEntity(string id, string displayName, string flavorText, BaseCost cost, List<Generator> generated, List<Generator> consumed, UnlockRule unlockRule, BuildRule buildRule) 
